...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForumUser.items_per_page'
        db.add_column(u'forumuser_forumuser', 'items_per_page',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForumUser.items_per_page'
        db.delete_column(u'forumuser_forumuser', 'items_per_page')
